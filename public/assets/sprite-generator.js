...
class SpriteGenerator {
  ...
  soilTile(variant = 0) {
    ...
    if (variant % 2 === 1) px.dither(6, 8, 18, 14, R[0], 0.3, rng);
    return px.canvas;
  }
  ...
  stoneTile(variant = 0) {
    ...
    for (const [x, y, w, h] of slabs) {
      px.rect(x, y, w, h, R[1]);
      px.hline(x, x + w - 1, y, R[3]);
      px.vline(x, y, y + h - 1, R[2]);
      px.hline(x, x + w - 1, y + h - 1, R[0]);
  ...
  pine(stage = 3) {
    ...
    for (let t = tiers - 1; t >= 0; t--) {
      ...
      for (let row = 0; row <= tierH; row++) {
        ...
        px.hline(24 + Math.max(0, w - 2), 24 + w, y, P[0]);
        if (row % 3 === 0) px.p(24 - w + 1, y, P[3]);
  ...
  livestock(type = 'cow', variant = 0, frame = 0) {
    ...
    if (type === 'chicken') {
      ...
      px.p(hx + 1, hy - 3, '#b03a2a'); px.p(hx, hy - 3, '#b03a2a');
      px.p(hx + 3, hy, '#c98a30'); px.p(hx + 4, hy, '#c98a30');
      px.p(hx + 1, hy - 1, O);
    ...
    if (type === 'sheep') {
      ...
      px.disc(13, hy - 1, 3, ramp[1]);
      px.p(8, hy + 1, '#0c0a08'); px.p(7, hy + 4, headRamp[0]); px.p(14, hy + 3, headRamp[0]);
    } else if (type === 'pig') {
      px.shadedBlob(13, hy + 4, 4.5, 4, ramp);
      px.rect(8, hy + 4, 3, 3, ramp[2]);
      px.p(9, hy + 5, '#5e352c'); px.p(10, hy + 5, '#5e352c');
      px.p(12, hy + 1, ramp[0]); px.p(13, hy, ramp[1]);
      px.p(11, hy + 3, '#0c0a08');
    } else {
      px.shadedBlob(10, hy + 1, 4.5, 4, headRamp);
      px.rect(5, hy + 2, 4, 3, headRamp[2]);
      px.p(6, hy + 3, '#241c12'); px.p(8, hy + 3, '#241c12');
      px.p(10, hy - 1, '#0c0a08');
  ...
  wildAnimal(type = 'deer', variant = 0, frame = 0) {
    ...
    if (type === 'wolf') {
      ...
      px.blob(18, 17, 5, 4.5, R[1]);
      px.hline(20, 32, 19, R[3]);
      px.blob(39, 13 - bob, 5, 2.5, R[1]);
      px.disc(41, 12 - bob, 2, R[0]);
      const hy = 10 + bob;
      px.shadedBlob(13, hy, 4, 3.5, [R[0], R[1], R[2]]);
      px.rect(7, hy, 4, 2, R[2]);
      px.p(7, hy, '#16120e');
      px.p(12, hy - 4, R[0]); px.p(12, hy - 5, R[1]);
      ...
      px.rect(5, 18 + bob, 3, 3, this.ramps.deer[1]);
      px.p(5, 19 + bob, '#1a1410');
      px.p(7, 21 + bob, '#e8e0cc'); px.p(6, 22 + bob, '#e8e0cc');
      px.p(10, 15 + bob, '#0c0a08');
      px.p(11, 12 + bob, R[0]);
      px.line(36, 13, 38, 18, R[0]);
    } else if (type === 'fox') {
      ...
      px.rect(10, hy + 1, 3, 2, R[2]);
      px.p(10, hy + 1, '#16120e');
      px.p(13, hy - 4, '#2c2017'); px.p(13, hy - 3, R[1]);
      px.p(17, hy - 4, '#2c2017'); px.p(17, hy - 3, R[1]);
      px.p(14, hy, '#0c0a08');
      px.rect(13, hy + 3, 4, 2, '#e0d6c0');
    } else {
      ...
      px.p(38, 13, '#e8e0cc'); px.p(38, 14, '#e8e0cc');
      px.line(20, 13, 16, 7 + bob, R[1], 2);
      px.shadedBlob(14, 6 + bob, 3, 2.5, R);
      px.p(10, 6 + bob, '#16120e');
      px.p(13, 5 + bob, '#0c0a08');
      px.p(17, 3 + bob, R[0]); px.p(18, 4 + bob, R[1]);
      if (variant % 2 === 0) {
  ...
  settler(gender = 'male', skinTone = 0, hairStyle = 0, opts = {}) {
    ...
    px.hline(11, 20, ty + 12, '#1f1a12');
    px.p(15, ty + 12, '#9c7a3a'); px.p(16, ty + 12, '#9c7a3a');
    px.p(15, ty, skin[1]); px.p(16, ty, skin[1]);
    const shY = ty + 2;
    if (pose === 'farm' || pose === 'mine') {
      ...
      const a0 = -2.1, a1 = 0.9;
      const ang = a0 + (a1 - a0) * (pose === 'farm' ? t * t : t);
    ...
    px.vline(19, hy0 + 1, hy0 + 6, skin[0]);
    px.vline(13, hy0 + 2, hy0 + 5, skin[2]);
    px.p(14, hy0 + 4, '#1a130c'); px.p(17, hy0 + 4, '#1a130c');
    ...
    if (style === 0) {
      ...
      px.rect(14, hy0 + 6, 4, 1, skin[1]);
      px.p(15, hy0 + 6, skin[0]); px.p(16, hy0 + 6, skin[0]);
    } else {
      px.rect(12, hy0 - 1, 8, 3, hair[1]);
      px.hline(13, 18, hy0 - 2, hair[1]);
      px.disc(16, hy0 - 3, 2, hair[1]);
  ...
  resource(type = 'grain', variant = 0) {
    ...
    if (type === 'grain') {
      ...
      px.rect(9, 13, 7, 2, this.ramps.bark[1]);
      px.hline(9, 15, 13, this.ramps.bark[2]);
      for (let i = -2; i <= 2; i++) px.p(12 + i * 2, 4 + Math.abs(i), G[3]);
    } else if (type === 'wood') {
      const B = this.ramps.bark;
      ...
      px.p(17, 6, '#e8e4da');
      px.line(6, 15, 11, 20, '#9c7a3a', 2);
      px.line(5, 21, 7, 19, this.ramps.bark[1], 2);
      px.p(4, 22, '#b89548');
    }
    px.outline(O);
    return px.canvas;
