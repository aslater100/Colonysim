...
- **Remaining spatial-AI follow-on:** player-faction auto-develop in autoplay (headless
  markers are player-centric; rivals re-baseline them only via competition — gate any
